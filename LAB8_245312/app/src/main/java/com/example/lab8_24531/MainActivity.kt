...
import com.example.lab8_24531.locations.LocationDetailScreen
import com.example.lab8_24531.locations.LocationListScreen
import com.example.lab8_24531.profile.ProfileScreen
        ...
        NavHost(
            ...
            navigation<LocationsDestination>(startDestination = LocationListRoute) {
                composable<LocationListRoute> {
                    LocationListScreen(onLocationClick = { id ->
                ...
                composable<LocationDetailDestination> { backStackEntry ->
                    ...
                    LocationDetailScreen(locationId = destination.id, onBackPressed = { navController.popBackStack() })
                }
            }
